          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <DialogTitle>Set your price right!</DialogTitle>
                  <DialogContent>
                    <div>{`Please enter the AEMO spot price for the completed event on ${moment(
                      datePrice
                    ...
                    {hasCompletedPrice !== "3" ? (
                      <DialogActions>
                        <Button
                          style={
                            isEmail === "0"
                              ? { backgroundColor: "#fff", color: "#83C4C4" }
                              : { backgroundColor: "#FBFBFB", color: "grey" }
                          }
                          disabled={isEmail === "0" ? false : true}
