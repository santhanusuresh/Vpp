...
const Layout = props => {
  ...
  const onProfileSave = () => {
    ...
    const { userid: userID, username, userpassword: password } = props.auth;
            ...
            {state.profile === "profile" ? (
              ...
              >
                ...
                >
                  ...
                  >
                    <div style={{ width: "100%", padding: state.editProfile ? "3% 6% 0% 6%" :"6% 0% 0% 6%" }}>
                      <Typography
                        style={{
                          color: "#BDBDBD",
                          fontFamily: "Gotham Rounded Medium",
...
export default withStyles(styles)( connect( mapStateToProps, { getSessionUser, logout } )(withRouter(Layout)));
