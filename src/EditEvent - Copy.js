...
class EditEvent extends Component {
      ...
      fetch(
        ...
        .then(res => {
          ...
          return this.setState({
            ...
            power: parseInt(state.event.sysReDPower) / 1000,
  ...
  onExportEvent = () => {
    ...
    window.open(
      "https://monitoring.shinehub.com.au/handler/web/Group/handleQueryExportGroupDispatch.php" +
        d
    );
  };
    ...
    fetch(
      ...
      .then(res => {
        ...
        fetch(
          ...
          .then(res => res.json())
          .then(res => {
            const updatedEvent = res.d.filter(
              event => event.sysReDId === state.event.sysReDId
            );
            ...
            return this.setState({
              ...
              power: parseInt(updatedEvent[0].sysReDPower) / 1000,
              completed: updatedEvent[0].sysReDIsComplete === "0" ? false : true
            });
          });
      });
  };
                    ...
                    >
                      ...
                      >
                        ...
                        {editClicked ? (
                          ...
                          >
                            {`${event.availablepower / 1000} kWh out of ${event.sysReDPower/1000} kWh`}
                          </Typography>
                        )}
                      </div>
                      <div
                ...
                <CardContent>
                  ...
                  >
                    ...
                    >
                      <img
                        src={arrowUp}
                        style={{ transform:'rotate(120deg)',minWidth: 19,maxWidth:50, height: "auto" }}
                      />
                      <Typography
                        style={{
                          paddingTop: "0",
                      ...
                      >
                        <img
                          src={arrowDown}
                          style={{ minWidth: 19,maxWidth:50, height: "auto" }}
                        />
                        <Typography
                          style={{
                            paddingTop: "0",
